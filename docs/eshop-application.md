# Run the eShop application

[Return to the context-engineering lesson](../README.md).

The source-reading lesson does not require running the application. This guide preserves the application setup material inherited from dotnet/eShop, with links adjusted for this folder and the clone command pointed at the teaching fork.
